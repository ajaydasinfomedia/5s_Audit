                    ...
                    <tr>
                        ...
                        <td align="center" >
						 ...
						 <div  title="Image/Comment" class="dialog-message<?php echo $i; ?>">
							...
							<textarea name="comment<?php echo $i; ?>"  class="qcomment comment<?php echo $i; ?>"><?php if(isset($flagt)){ echo $comment[$i];}?></textarea> 
						 ...
						 <td align="center " class="last<?php echo $i; ?>" >
							...
							<?php if(isset($flagt)) { 
								if($comment[$i] != '' || $imageold[$i] != ' ')	{?>
							<input type="button" id="opener" class="opener<?php echo $i; ?> seaBtn" value="Edit" >
							<?php } 
							else
								{ ?>
								<input type="button" id="opener" class="opener<?php echo $i; ?> blueBtn" value="Add" >
							<?php } } 
							else
								{ ?>
								<input type="button" id="opener" class="opener<?php echo $i; ?> blueBtn" value="Add" >
