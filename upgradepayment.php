<?php
	...
	mysqli_query($sqlnew,$supdate) or die(mysqli_error($sqlnew));
	if($price == 0)
	{
...
<input type="hidden" name="notify_url" value="http://5s.niftysol.com/renewlistner.php">
...
<input type="hidden" name="item_name" value="5s - upgrade">
