<?php include("header.php"); ?>
 ...
 <div class="content" style="margin-left:200px;">
    	<div class="title"><h5>Users with Large Plan</h5></div>
<div class="widget">	
...
<h5 class="iList">Users</h5>
 ...
 include("dbconnect.php");
   $query = "SELECT l.*, lr.dbname as db FROM `tbl_login` as l, tbl_plan as p,tbl_login_relation as lr WHERE p.plan_id=3 and p.uid = l.`uid` and p.active_status = 1 and lr.`uid` = p.uid and lr.uid = l.`uid` and lr.producttype like '5s'" ;
