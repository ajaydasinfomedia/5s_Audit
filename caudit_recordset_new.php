...
<div class="content">
    <form action="addprojectreview.php" method="post"  name="frm" enctype="multipart/form-data">
            ...
            <table id="CRZNaN" class="tableStatic resize CRZ" width="100%" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                        ...
                        <td style="width:40%;font-weight: bold;"><?php echo DESCRIPTION ?></td>
						...
						<td style="width: 23%;font-weight: bold;"><?php echo "Comment"; ?></td>
						<td style="width: 5%;font-weight: bold;"><?php echo "Image"; ?></td>
				...
				<tbody>	
                    <tr>
                        ...
                        <td align="center" >
						 ...
						 <td align="center" >
							<input type="text" name="comment<?php echo $i; ?>" value="<?php if(isset($flagt)){ echo $comment[$i]; } ?>" class="qcomment">
						</td>	
						 <td align="center" >
							
							<input type="file" name="img<?php echo $i; ?>" class="qimage">
						</td>	
                    </tr>	
				<?php
