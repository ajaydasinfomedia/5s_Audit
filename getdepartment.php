...
<div class="" style="position: relative;width: 190px;">
	<span id="dname" style="background: url('../images/forms/select_right.png') no-repeat scroll right center transparent;cursor: pointer;font-size: 11px;
    ...
    <select  name="drpdept"  style="position: relative;" id="dd" onchange="return show(this.value)" class="form-control form-control-sm imgopocity">
