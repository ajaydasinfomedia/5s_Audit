 ...
 */
   ...
   function pagination($query, $per_page = 10,$page = 1, $url = '?'){ 
    	...
    	{       
    			...
    			for ($counter = 1; $counter <= $lastpage; $counter++)
    			{
    				if ($counter == $page)
    					$pagination.= "<span class='fg-button ui-button'><a class='ui-state-disabled'>$counter</a></span>";
                                        ...
                                        {
                                              $l=$_REQUEST["limit1"];
    					$pagination.= "<span class='fg-button ui-button'><a href='{$url}limit1=$l&page=$counter'>$counter</a></span>";					
                                        }
                                        else
                                        {
                                            $pagination.= "<span class='fg-button ui-button'><a href='{$url}page=$counter'>$counter</a></span>";					
                                        }
    		...
    		if ($page < $counter - 1){ 
    			$pagination.= "<span class='next fg-button ui-button'><a href='{$url}page=$next'>Next</a></span>";
                $pagination.= "<span class='last ui-corner-tr ui-corner-br fg-button ui-button'><a href='{$url}page=$lastpage'>Last</a></span>";
    		}else{
