...
mysqli_select_db($link,$id1) or die ('Can\'t use foo : ' . mysqli_error($link));

$sql_tbl_dept = "CREATE TABLE IF NOT EXISTS `adddepartment` (
...
$sql_tbl_template= "CREATE TABLE IF NOT EXISTS `addtemplate` (
  ...
  `temptype` varchar(255) NOT NULL,
   `modified_date` timestamp NOT NULL DEFAULT '1970-01-05',
...
$sql_tbl_project_review="CREATE TABLE IF NOT EXISTS `tbl_project_review` (
...
$sql_tbl_questionanswer="CREATE TABLE IF NOT EXISTS `tbl_questionanswer` (
...
$sql_tbl_questionnair="CREATE TABLE IF NOT EXISTS `tbl_questionnair` (
...
$sql_tbl_settings="CREATE TABLE IF NOT EXISTS `tbl_settings` (
...
mysqli_query($link,$sql_tbl_settings) or die(mysqli_error($link));

$utf = "set names 'utf8'";
mysqli_query($link,$utf)or die(mysqli_error($link));
