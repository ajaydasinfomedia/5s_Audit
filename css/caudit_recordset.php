            ...
            <table id="CRZNaN" class="tableStatic resize CRZ" width="100%" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                        ...
                        <td style="width:45%;font-weight: bold;"><?php echo DESCRIPTION ?></td>
                        <td style="width: 20%;font-weight: bold;"><?php echo SCORE ?>
                            <p>
						...
						<td style="width: 10%;font-weight: bold;"><?php echo IMAGE ?></td>
						<td style="width: 10%;font-weight: bold;"><?php echo COMMENT ?></td>
                  	</tr>
            	</thead>
				<?php
                $str_explode = explode('/',$_SERVER['REQUEST_URI']);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
						 ...
						 <div class="col-sm-3">
							...
							<div class="col-sm-9">
							<input type="textarea" name="comment<?php echo $i; ?>">
							</div>
							</div>
      </div>
