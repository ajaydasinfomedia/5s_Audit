...
<base href="http://5s.niftysol.com/admin" />
...
<div id="topNav">
    <div class="fixed">
        <div class="wrapper">
            <div class="welcome"><a href="#" title=""><img src="images/userPic.png" alt="" /></a><span>Welcome
			<?php if(isset($_SESSION['uname'])){ echo $_SESSION['uname'];} ?> </span></div>
            <?php 
            ...
            <div class="userNav">
                <ul>                    
                    <li><a href="admin/admin_logout.php" title="">
			...
			<div class="userNav">
                <ul>
					<li><a href="admin/admin_login.php"><img src="images/icons/topnav/profile.png" alt="" /><span> Login</span></a></li>                    
...
<div id="header" class="wrapper">
    <div class="logo"><a href="#" title=""><img src="images/logo_final-1.png" alt="" /></a></div>            
